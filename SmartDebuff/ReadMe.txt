...
6.0b    2014-10-23  Fixed issue with default heal spells

6.0a    2014-10-16  Updated code for Warlords of Draenor
                    Included Broker addon
                    Thanks for donation: 	Jennyfer H :)
...
5.1b    2013-01-13  Updated Druid debuff detection (Cleanse from Symbiosis)

5.1a    2012-12-21  Added option to ignore debuff display, if the debuff spell is on cooldown
                    Added display of debuff spell cooldown
                    Updated Druid debuff detection (Remove Corruption, Cleanse from Symbiosis)
                    Auto enable Monk class
                    Popup question to reset the spell bindings
                    Updated TOC

5.0d    2012-09-10  Fixed Priest and Druid debuff detection issue

5.0c    2012-09-01  Fixed possible 'taint' issue in combination with the Glyph UI

5.0b    2012-08-30  Updated events
...
4.2a    2011-06-29  Updated TOC

4.1a    2011-04-28  Updated TOC

4.0g    2011-02-21  Added 'Stop Casting' option, if enabled it stops immediately the current casting/channeling, to cast the defined debuff spell

4.0f    2010-12-25  Added advanced anchor setup for the debuff frame
                    Added option slider for the raid/role icon size
                    Added option sliders for button space X and Y
                    Added 'Color Setup' button and option frame
                    Added 'Test Mode' button
                    Updated button and color layout

4.0e    2010-12-08  Added check for not yet learned debuff spells
                    Fixed annoying click sound issue, if the unit popup menu is used
                    Fixed frame moving, if background is disabled

4.0d    2010-11-22  Added 'Role' checkbox to support sort by role. Sort by role is only active, if everyone in the group/raid has choosen the role.

4.0c    2010-11-10  Added option to assign the unit menu in the mouse bindings
                    Added 'Debuff Alert Sound' ('A' button), displays alert sounds. Left click to use it as default sound or right click to play it.
                    Added 'Debuff Alert Sound' option frame
                    Whats new info only on the very first login

4.0b    2010-10-18  Initialization updated to detect skilled talents correctly
                    Updated imp spell (warlock pet)
                    Added drag'n'drop of pet spells
  
4.0a    2010-10-14  Updated code for Cataclysm
                    Updated debuff spell list
                    Key assignments has been reset
                    Added global 'Save' / 'Load' function for settings

3.3f    2010-08-18  Added 'Spell Guard' ('S' button), displays icons for the listed spells. Enter a custom spell in the textbox and press enter to add it. Drag'n'drop to change the order, right click to remove it.
